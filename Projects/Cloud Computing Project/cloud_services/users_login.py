...
try:
	def proxy():
		ip=commands.getoutput("dialog --inputbox  'Enter the ip u wanna connect' 10 40  --stdout")
		port=commands.getoutput("dialog  --inputbox 'Enter the port u wanna connect to' 10 40  --stdout")
		...
		if (int(port) ==5465):
			...
			def log():
				...
				#incorrect login retry
					...
					os.system("dialog --infobox 'Incorrect username or passwd......' 10 30 ")
					time.sleep(2)
